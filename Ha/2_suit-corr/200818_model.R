...
# a <- m.stab.ind$summary[,-1]#stable except for z.rec and interactions
# save(a, file='model_stab.Rdata')

load('model_stab.Rdata')
a#z.prec and z.temp not stable
...
source('/Users/cdesjonq/Documents/stats_glmm/functions/boot_glmm.r')
